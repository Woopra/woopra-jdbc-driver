...
public class WoopraDatabaseMetaData implements DatabaseMetaData {

    private static final String SCHEMA_NAME = "PUBLIC";

    private Connection createdByConnection;
    private WoopraStatement internalStatement = null;

    public WoopraDatabaseMetaData(Connection createdByConnection) {
    ...
    public ResultSet getAttributes(String arg0, String arg1, String arg2,
        ...
        throw new UnsupportedOperationException("DatabaseMetaData.getAttributes(String,String,String,String)");
    }
    ...
    public ResultSet getColumns(String catalog, String schemaPattern,
        ...
        try {
            if (internalStatement == null) {
                internalStatement = (WoopraStatement) createdByConnection.createStatement();
            }
    ...
    public ResultSet getCrossReference(String arg0, String arg1, String arg2,
        ...
        throw new UnsupportedOperationException("DatabaseMetaData.getCrossReference(String,String,String,String,String,String)");
    }
    ...
    public ResultSet getProcedureColumns(String arg0, String arg1, String arg2,
            String arg3) throws SQLException {
        throw new UnsupportedOperationException("DatabaseMetaData.getProcedureColumns(String,String,String,String)");
    }
    ...
    public ResultSet getSuperTables(String arg0, String arg1, String arg2)
            throws SQLException {
        throw new UnsupportedOperationException("DatabaseMetaData.getSuperTables(String,String,String)");
    }

    @Override
    public ResultSet getSuperTypes(String arg0, String arg1, String arg2)
            throws SQLException {
        throw new UnsupportedOperationException("DatabaseMetaData.getSuperTypes(String,String,String)");
    }
...
//            }
//        }
        ResultSet retval = createResultSet(columnNames, columnTypes, new ArrayList());
        return retval;
    }

    private ResultSet createResultSet(String columnNames, String columnTypes, List<Object[]> columnValues) throws SQLException {

        return new WoopraResultSet(null, "");
    }
...
//        return retval;
    ...
    public ResultSet getTypeInfo() throws SQLException {
        ...
        List<Object[]> columnValues = new ArrayList();//StringConverter.getTypeInfo();
        ResultSet retval = createResultSet(columnNames, columnTypes, columnValues);
        return retval;
    }
...
//        WoopraConnection w = (WoopraConnection) createdByConnection;
//        return w.getURL();
        return null;
    }
